...
> [**GitHub Release**](https://github.com/pgsty/pigsty/releases/tag/v2.5.0) | [**发布注记**](https://pigsty.cc/docs/releasenote/#v250)

[![Pigsty v2.5：Ubuntu & PG16](featured.jpg)](https://github.com/pgsty/pigsty/releases/tag/v2.5.0)
...
[**Pigsty**](/pigsty/v2.0/) 是一个开箱即用的 [**PostgreSQL**](/pg/pg-is-no1/) 发行版，提供本地优先的 RDS PG 开源替代。它让用户用云数据库 RDS 几分之一的纯硬件成本，自助运行更好的企业级 PostgreSQL 数据库服务。更多介绍请访问 [pigsty.cc](https://pigsty.cc/)。
...
在《[临水照花看 Ubuntu 与 Debian：Pigsty v2.5](http://mp.weixin.qq.com/s?__biz=MzU5ODAyNTM5Ng==&mid=2247486263&idx=1&sn=4288450c04a6fdbaf5e4fae385d42bd9&chksm=fe4b3eecc93cb7faf32a8c30ab78870f8ca607ad572e9d6725ac9f64c1549071c3d33a802019&scene=21#wechat_redirect)》中，我们已经预告了对 Ubuntu / Debian 系操作系统的支持（以下简称 Deb 支持）。从两年前 0.x 版本的时代，就有用户提出想要 Ubuntu 和 Debian 操作系统支持了，所以我觉得这是一件非常正确且重要的事情。
...
[如何用 Pigsty 监控现有 PostgreSQL (RDS/PolarDB/自建)？](/pigsty/monitor-existing-pg/)

[Pigsty 特性与快速上手](/pigsty/v2.0/)

[EL 系操作系统发行版哪家强？](/db/rhel-compatibility/)

[临水照花看 Ubuntu 与 Debian：Pigsty v2.5](http://mp.weixin.qq.com/s?__biz=MzU5ODAyNTM5Ng==&mid=2247486263&idx=1&sn=4288450c04a6fdbaf5e4fae385d42bd9&chksm=fe4b3eecc93cb7faf32a8c30ab78870f8ca607ad572e9d6725ac9f64c1549071c3d33a802019&scene=21#wechat_redirect)

[PostgreSQL：世界上最成功的数据库](/pg/pg-is-no1/)

[Pigsty 2.4：PG16 支持，RDS 监控与新扩展！](/pigsty/v2.4/)

[Pigsty v2.3.1：HNSW 版 PGVECTOR 来了！](/pigsty/v2.1/)

[Pigsty v2.3 发布：应用生态丰富](/pigsty/v2.3/)

[Pigsty v2.2 发布 —— 监控系统大升级](/pigsty/v2.2/)

[Pigsty v2.1 发布：向量扩展 / PG12-16 支持](/pigsty/v2.1/)

[Pigsty v2.0.2 更好的开源 RDS 替代：Pigsty](/pigsty/v2.0/)

[Pigsty v2.0 发布，炮打 RDS](/pigsty/v2.0-launch/)

[Pigsty v2 正式发布：更好的 RDS PG 开源替代](/pigsty/v2.0/)

[Pigsty v1.5.1 发布](/pigsty/v1.0/)

[Pigsty v1.5 发布与新特性](/pigsty/v1.5/)

[Pigsty v1.4 正式发布！](/pigsty/v1.4/)

[Pigsty v1.4 前瞻](/pigsty/v1.4-preview/)
...
[开箱即用的 Redis 发行版 —— Pigsty v1.3](/pigsty/v1.3/)

[Pigsty v1.2 发布](/pigsty/v1.2/)

[Pigsty v1.1 发布/新功能介绍](/pigsty/v1.1/)

[Pigsty v1 正式发布：开箱即用的 PostgreSQL 开源发行版](/pigsty/v1.0/)
...
- `[4]` Ubuntu: <https://github.com/pgsty/pigsty/blob/v2.5.0/files/pigsty/ubuntu.yml>
- `[5]` Debian: <https://github.com/pgsty/pigsty/blob/v2.5.0/files/pigsty/debian.yml>
- `[6]` `ubuntu.yml`: <https://github.com/pgsty/pigsty/blob/v2.5.0/files/pigsty/ubuntu.yml>
...
发布版本：[微信公众号](https://mp.weixin.qq.com/s/UB4ox_wiSOABNqCBdrx-Jg)
